...
const schema = new mongoose.Schema({
    name: { type: String },
    book_code: { type: String, unique: true },
    description: String,
    author: {
    ...
    historical_cost: {type: Number, default: 0},
    thumbnail: { type: String, default: 'https://www.worldbookday.com/wp-content/themes/wbd-2015/images/logo.png' },
